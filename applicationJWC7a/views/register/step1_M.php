...
<!--////////////////////////////////////////////////////////////////////////////////////////////////-->
				...
				<div id="step4" class="stepitem" data-step="4">
					...
					<div class="col-sm-10 col-sm-offset-1">
						...
						<hr>
						<div class="row form-field txt-left">
							<label for="name">1. หากน้องถูกจ้างให้เข้าไปเป็นตำแหน่ง ดูแลการขาย ในสภาวะการเงินของบริษัทย่ำแย่ น้องคิดว่า จะช่วยดึงดูดลูกค้า และชนะคู่แข่งได้โดยวิธีใดบ้าง (สามารถเลือกประเภทธุรกิจเองได้)</label>
...
<!--////////////////////////////////////////////////////////////////////////////////////////////////-->
	...
	<script>
		$(function() {
			$("#inputPhone,#inputParentPhone").keyup(function(){
				var txt = $(this).val();
				var res = "";
				var reg = new RegExp("[0-9]");
				for( var i=0; i<txt.length; i++ ) {
					if( reg.test( txt[i] ) ) res += txt[i];
				}
				$(this).val( res );
			});
