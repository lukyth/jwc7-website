...
<head>
	...
	<title>JWC7 Profile Image Maker</title>
...
<body>
	<div class="container-fluid eg-container" id="basic-example">
		<div class="row">
			<h1 class="text-center">All the credit goes to <a href="https://www.facebook.com/moshikub" target="_blank">Moshikub Programmer</a></h1>
		</div>
		<div class="step">
		...
		<div class="step">
			...
			<div class="eg-wrapper">
				<img class="cropper" src="img/cutemak.jpg" alt="Picture">
			</div>
		</div>
	...
	<div style="width:0px; height:0px; overflow:hidden;"><img src="/profile_image_maker/img/jwc7.png"></div>
